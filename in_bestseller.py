...
with open('output/in_book.csv', 'w') as out_file:
    writer = csv.writer(out_file, delimiter=';')
    writer.writerow(['NAME', 'URL', 'AUTHOR', 'PRICE', 'NUMBER OF RATINGS', 'AVERAGE RATING'])

    for i in range(5):
        url = 'https://www.amazon.in/gp/bestsellers/books/ref=zg_bs_pg_{}?ie=UTF8&pg={}'
        ...
        for x in page_data:
            ...
            if link is None:
                ...
                ans.append(('https://www.amazon.in' + link['href'].strip()))
